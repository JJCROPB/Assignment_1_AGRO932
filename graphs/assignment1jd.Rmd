...
setwd("D:/Documents/GitHub/Assignment_1_AGRO932/")
#reading the sequence data
geno <- read.table("data/data2/geno.txt", header=FALSE)
...
#to output fst values
write.table(geno, "fst2.csv", sep=",", row.names = FALSE, quote=FALSE)
```

```{r}
#to plot the fst values
fst <- read.csv("fst2.csv")
#to save as a pdf
pdf(file = "Fst_wmutation20.PDF",   # The directory you want to save the file in
    width = 4, # The width of the plot in inches
    height = 4) # The height of the plot in inches
plot(fst$pos, fst$fst, xlab="Physical position", ylab="Fst value", main="")
